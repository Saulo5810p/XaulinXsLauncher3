...
fun defaultWidgetPickerTextStyles() =
    WidgetPickerTextStyles(
        // Titled bottom sheet
        sheetTitle = MaterialTheme.typography.headlineSmall.copy(fontWeight = FontWeight.Medium),
        ...
        toolbarSelectedTabLabel = MaterialTheme.typography.labelLarge.copy(fontWeight = FontWeight.Bold),
